...
public class NewProjectPage extends BaseView {
    ...
    @Step("Check create new project page visibility")
    ...
    @Step("enter the project name {projectName}")
    ...
    @Step("click on project type checkbox")
    public NewProjectPage clickProjectType(){
        checkProjectType.click();
        return this;
    }

    @Step("select priority of the project {value}")
    ...
    @Step("select the finance source of the project {value}")
    ...
    @Step("select the business unit of the project {value}")
    ...
    @Step("select the project curator {value}")
    ...
    @Step("select the project director {value}")
    ...
    @Step("select the project manager {value}")
